...
const percent = '15% Off!'
const title= percent.replace('15%','10%' )
console.log(title)
/*
...
const desc= month.replace('March','April' )
console.log(desc)

const whiteSpace = '   This deal lasts until the end of April! '
